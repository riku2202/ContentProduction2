...
namespace Game 
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                DebugManager.LogMessage("Rigidbody コンポーネントが見つかりません！", DebugManager.MessageType.Error);
            }

            if (animator == null)
            {
                DebugManager.LogMessage("Animator コンポーネントが見つかりません！", DebugManager.MessageType.Error);
            }
        ...
        private void HandleActionInput()
        {
            ...
            {
                DebugManager.LogMessage("アクションボタンが押されました！");
        ...
        private void Jump()
        {
            ...
            isGrounded = false;
            DebugManager.LogMessage("ジャンプしました！");
        }
        ...
        private void Shoot()
        {
            ...
            {
                DebugManager.LogMessage("弾のPrefabまたは発射位置が設定されていません！", DebugManager.MessageType.Error);
                return;
            }
            ...
            StageScene.Magnet.BulletController bulletController = bullet.GetComponent<StageScene.Magnet.BulletController>();
