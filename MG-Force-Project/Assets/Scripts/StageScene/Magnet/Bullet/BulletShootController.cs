    ...
    public class BulletShootController : MonoBehaviour 
    {
        ...
        private void Update()
        {
            ...
            if (_canShooting)
            {
                ...
                DebugManager.LogMessage("î≠éÀÅ[ÅIÅIÅI");
        ...
        private void ChageUpdate()
        {
            ...
            if (_isCharging)
            {
                _chargeGageObj.transform.localScale = new Vector3(-1f, 1f, 1f);  // Xé≤ÇîΩì]
            }
            else
            {
                _chargeGageObj.transform.localScale = new Vector3(1f, 1f, 1f);   // å≥Ç…ñﬂÇ∑
            }
        }
    }
}